...
rappresenta la connessione con il DB. Se non ci riesce non restituisce nulla
    ...
    Ovviamente deve esitere un DB $database sul server "$server", deve esistere un utente di nome $userName con password $password (quando mi impegno riesco a creare password difficilissime)
    ...
    <body>
        ...
        ?>
            ...
            */
            ...
            ?>
        <div class="content">
            Oggi proviamo a fare un miniblog
        </div>
